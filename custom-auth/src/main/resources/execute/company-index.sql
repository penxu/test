...
COMMENT ON TABLE im_circle_comment_replace IS '同事圈评论表';
...
COMMENT ON TABLE im_circle_main_replace IS '同事圈发布信息表';
...
COMMENT ON TABLE im_circle_photo_replace IS '同事圈头像类';
...
COMMENT ON TABLE im_circle_up_replace IS '同事圈点赞表';
...
COMMENT ON TABLE public.attachment_approval_replace IS '附件表';
COMMENT ON COLUMN public.attachment_approval_replace.id IS '主键ID';
COMMENT ON COLUMN public.attachment_approval_replace.data_id IS '数据id';
COMMENT ON COLUMN public.attachment_approval_replace.file_name IS '附件名称';
COMMENT ON COLUMN public.attachment_approval_replace.file_type IS '附件类型';
COMMENT ON COLUMN public.attachment_approval_replace.file_size IS '附件大小';
COMMENT ON COLUMN public.attachment_approval_replace.file_url IS '附件URL';
COMMENT ON COLUMN public.attachment_approval_replace.original_file_name IS '服务器文件名称';
COMMENT ON COLUMN public.attachment_approval_replace.serial_number IS '序列号';
COMMENT ON COLUMN public.attachment_approval_replace.upload_by IS '附件上传者';
COMMENT ON COLUMN public.attachment_approval_replace.upload_time IS '附件上传时间';
COMMENT ON COLUMN public.attachment_approval_replace.bean IS '所属对象';
COMMENT ON COLUMN public.attachment_approval_replace.idx IS '所属行';
...
COMMENT ON COLUMN auto_sequence_number_replace.date_format IS '时间格式';
...
COMMENT ON COLUMN "public"."personel_task_replace"."seas_pool_id" IS '公海池编号';
