...
public class PathUtil
{
    ...
    public static String getClassesRealPath()
    {
        ...
        if (StringUtil.isBlank(classesRealPath))
        {
            throw new NullPointerException("classesRealPath==null");
        }
        classesRealPath = classesRealPath.trim();
        while (classesRealPath.indexOf(":") > 0 && (classesRealPath.startsWith("/") || classesRealPath.startsWith("\\")))
        {// windows下删除第一个
            // linux下不要删除
    ...
    public static String getRealPathByClass()
    {
        ...
        while (realPath.indexOf(":") > 0 && realPath.startsWith("/"))
        {// windows下删除第一个
            // linux下不要删除
     ...
     * 
     * @param s 如：front/person/templet/，不支持../路径
    ...
    public static String getResourceFilePath(String fileName)
    {
        ...
        while (filePath.indexOf(":") > 0 && (filePath.startsWith("/") || filePath.startsWith("\\")))
        {// windows下删除第一个
            // linux下不要删除
