 ...
 * 
*@Title:
*@Description:公司套餐开始时间定时器 
*@Author:liupan
*@Since:2018年4月9日
*@Version:1.1.0
 */
public class PulicCompanyStart implements Job
{

    private static final Logger LOG = LogManager.getLogger(PulicCompanyStart.class);
        ...
        throws JobExecutionException
    {
        ...
        StringBuilder sql = new StringBuilder("select * from ").append(formalTable).append(" where start_time < ").append(System.currentTimeMillis());
