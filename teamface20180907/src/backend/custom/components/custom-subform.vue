    ...
    <div class="setting-detail">
      ...
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item name="1">
          ...
          <div class="input-box">
            <el-input v-model="subformComponent.label" placeholder="请输入内容..."  maxlength="25"></el-input>
          </div>
          <div class="input-box" v-if="isShowPointOut">
            <label for="">提示框</label>
            <el-input v-model="subformComponent.field.pointOut" placeholder="请输入"></el-input>
          </div>
        ...
        <el-collapse-item name="3" v-if="subformComponent.type == 'picklist'">
          ...
          <div class="add-btn">
            <el-button plain size="mini" icon="el-icon-plus" @click="handleAddItem(subformComponent.type)">添加</el-button>
          </div>
          <div class="input-box">
            <label for="">默认值</label>
        ...
        <el-collapse-item name="12" v-if="subformComponent.type === 'mutlipicklist'">
          ...
          <el-radio-group size="mini" v-model="subformComponent.field.selectType">
          ...
          <div class="add-btn">
            <el-button plain size="mini" icon="el-icon-plus" @click="handleAddItem(subformComponent.type)">添加选项</el-button>
          </div>
        ...
        <el-collapse-item name="15" v-if="isFormula">
          ...
          <div class="input-box" v-show="subformComponent.field.numberType === '4'">
            <label for="">类型</label>
            <el-select v-model="subformComponent.field.decimalLen" placeholder="yyyy-MM-dd">
              <el-option v-for="date in dateList" :key="date.name" :label="date" :value="date">
              </el-option>
            </el-select>
          </div>
        ...
        <el-collapse-item name="18" v-if="subformComponent.type === 'reference'">
          ...
          <div class="input-box">
           ...
           <div class="refe-box" v-show="searchFieldList.length > 0">
            ...
            <el-select v-model="subformComponent.searchFields" value-key="fieldName" multiple>
