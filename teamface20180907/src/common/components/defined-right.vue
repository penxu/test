      ...
      <div class="property-box">
        ...
        <el-collapse v-model="activeNames" v-show="isShowFieldSetting">
          ...
          <el-collapse-item name="1">
            ...
            <div class="input-box">
              <el-input v-model="myComponent.label" placeholder="请输入内容..." :disabled="myComponent.name === 'reference_relation'"></el-input>
            </div>
          ...
          <!-- 单选、多选 -->
          <el-collapse-item name="2" v-if="isShowChooseType && myComponent.name !== 'picklist_tag'">
            <template slot="title">
              <i class="el-icon-caret-right"></i>类型
            </template>
            <div class="input-box">
              <el-select v-model="defaultChooseType" @change="modelChange('chooseType',$event)" placeholder="请选择" :disabled="myComponent.name === 'picklist_priority' || myComponent.name === 'personnel_execution'">
          ...
          <!-- 下拉选项  -->
          <el-collapse-item name="3" v-if="myComponent.type === 'picklist' && myComponent.name !== 'picklist_tag'">
            <template slot="title">
            ...
            <div class="input-box">
              <label for="" v-if="myComponent.field.chooseType === '0'">默认值</label>
          ...
          <el-collapse-item name="7" v-if="myComponent.type === 'datetime'">
            ...
            <div class="input-box">
              <el-select v-model="myComponent.field.formatType" placeholder="年-月-日" :disabled="myComponent.name === 'datetime_starttime'">
          ...
          <el-collapse-item name="13" v-if="myComponent.type === 'personnel'">
            ...
            <div class="input-box">
              <el-input v-model="defaultMemberValue" placeholder="请选择" @focus="selectMeber(myComponent.field.chooseType,'definedPersonnel')" readonly :disabled="myComponent.name === 'personnel_execution'"></el-input>
            </div>
            <div class="input-box">
              <label for="">可选范围</label>
              <el-input v-model="memberChooseRange" placeholder="请选择" @focus="selectMeber('1','chooseRangePersonnel')" readonly :disabled="myComponent.name === 'personnel_execution'"></el-input>
            </div>
          </el-collapse-item>
          <!-- 公式 -->
        ...
        <el-collapse-item name="28" v-if="myComponent.type === 'subform'">
          ...
          <el-collapse-item name="21" v-if="myComponent.type !== 'subform'">
            ...
            <el-radio-group size="mini" v-model="myComponent.width" :disabled="myComponent.name === 'text_name'">
          ...
          <el-collapse-item name="23" v-if="isShowfieldControl">
            ...
            <el-radio-group size="mini" v-model="myComponent.field.fieldControl" :disabled="myComponent.name === 'personnel_principal' || myComponent.name === 'text_name'">
          ...
          <el-collapse-item name="24" v-if="isShowfieldAuth">
            ...
            <div class="checkbox-box" >
              <el-checkbox true-label='1' false-label='0' v-model="myComponent.field.addView" :disabled="isDisabledFieldAuth">新增时显示</el-checkbox>
              <el-checkbox true-label='1' false-label='0' v-model="myComponent.field.editView" :disabled="isDisabledFieldAuth">编辑时显示</el-checkbox>
            </div>
          </el-collapse-item>
          <!-- 查重 -->
          <el-collapse-item name="25" v-if="myComponent.field.repeatCheck">
            ...
            <el-radio-group size="mini" v-model="myComponent.field.repeatCheck" :disabled="myComponent.name === 'text_name'">
          ...
          <!-- <el-collapse-item name="26">
            ...
            <div class="checkbox-box">
              ...
              <el-checkbox v-model="myComponent.field.formulaCalculates" true-label='1' false-label='0' v-if="formulaOrthersetting">新公式是否对旧数据重新计算</el-checkbox>
            </div>
          </el-collapse-item> -->
        </el-collapse>
      </div>
    </div>
    <transition name="slide-subform">
...
<script>
import DefinedSubform from '@/common/components/project-defined-subform'
...
export default {
  ...
  computed: {
    ...
    isShowChooseType () {
      ...
      switch (this.myComponent.type) {
        case 'picklist': case 'multi': case 'personnel': case 'picklist_tag':
          isShow = true
          break
        default:
          isShow = false
    ...
    // 公式其他设置
    formulaOrthersetting: {
      get: function () {
        let isShow
        if (this.myComponent.type === 'formula' || this.myComponent.type === 'functionformula' || this.myComponent.type === 'seniorformula') {
          isShow = true
        } else {
          isShow = false
        }
    ...
    // 是否禁用字段权限
    isDisabledFieldAuth () {
      return this.myComponent.name === 'personnel_principal' || this.myComponent.name === 'text_name' || this.myComponent.name === 'datetime_deadline' || this.myComponent.name === 'personnel_execution'
    },
    ...mapGetters([
      'getCurrentFields'
    ]),
  ...
  watch: {
    ...
    //   // console.log(newIndex, this.getCurrentFields(newIndex), 'newIndex')
    //   // this.myComponent = this.getCurrentFields(newIndex)
    // }
  },
  filters: {
    toText (value, type) {
