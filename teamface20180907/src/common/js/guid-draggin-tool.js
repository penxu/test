...
function GuidedDraggingTool () {
  ...
  var shapeProperties = {stroke: '#26D0E0', isGeometryPositioned: true, strokeDashArray: [6, 6, 2, 2]}
  /** @ignore */
  this.guidelineHtop =
  ...
  /** @type {string} */
  this._horizontalGuidelineColor = '#26D0E0'
  /** @type {string} */
  this._verticalGuidelineColor = '#26D0E0'
  /** @type {string} */
  this._centerGuidelineColor = '#26D0E0'
  /** @type {number} */
  this._guidelineWidth = 2
  /** @type {number} */
