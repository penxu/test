<template>
  <div class="component-item" :class="{'top-bottom':property.field.structure === '0','input-error':error}">
    ...
    <el-input type="text" v-model="property.field.defaultValue" :placeholder="property.field.pointOut"
      :name="property.name" :disabled="property.field.fieldControl === '1'" :maxlength="20" clearable @change="setValue" @blur="changevalue">
    </el-input>
...
export default {
  ...
  methods: {
    ...
    // 组件赋值
    setValue () {
      if (this.property.field.phoneType === '1' && this.property.field.phoneLenth === '1') {
