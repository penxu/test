<template>
  <div class="dustbin-main-wrip">
    ...
    <div class="Inbox" v-if="judge && !judgeAndRecords">
      ...
      <el-dropdown  v-if="!judgeAndRecords">
        <el-button>
    ...
    <div class="contentList" :class="{'for-records':judgeAndRecords}">
      <div class="List" :class="{'judgeList':judgeAndRecords}">
        <EmailList v-if="judge" :listContent="listContent" :navId="{'label':false, 'id': 5}" :recordObj='recordObj'></EmailList>
...
export default {
  ...
  methods: {
    ...
    // 获取列表数据
    getEmailList () {
      var jsondata = {'pageNum': this.pageNum, 'pageSize': this.pageSize, 'boxId': 5}
