  ...
  <div class="memo-detail-box">
    ...
    <div class="big-memo-detail">
      <div class="memo-detail">
        ...
        <!-- 编辑弹窗 -->
        <div class="creatMemo">
          <el-dialog title="编辑备忘" class="creat-memo" :append-to-body="true" :close-on-click-modal="false" :visible.sync="dialogForCreate" width="760px">
...
// 新款弹窗
.creat-memo.el-dialog__wrapper >.el-dialog {
  .el-dialog__header {
