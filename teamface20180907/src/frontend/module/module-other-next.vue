<template>
  <div class="module-other-next-wrip" :style='{height:hin}'>
    <ul class="l-navtab ">
        <li class="line"></li>
        ...
        <li @click='moduletlt(4)' :class="nextflag==4 ? 'active':''" v-if="shows.seeState"><i class="iconfont icon-liebiao"></i> 查看状态</li>
...
.module-other-next-wrip{
  .seestate-box{
    .el-table th,.el-table--enable-row-transition .el-table__body td{text-align: center;}
  }
}
</style>
